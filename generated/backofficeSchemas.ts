...
export type OrganizationFullBean = {
  acronym?: string;
  address?: AddressBean;
  dataProducts?: RelatedItemBean[];
  email?: string[];
  identifiers?: IdentifierBean[];
  instanceid?: string;
  legalName?: string;
  leiCode?: string;
  logo?: string;
...
export type SoftwareDetailsResponse = {
  type?: string;
};
