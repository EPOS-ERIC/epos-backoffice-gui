...
export class DeleteCategoryScheme extends Endpoint<
...
> {
  ...
  protected callLive(body: CategorySchemeType): Promise<CategorySchemeDataSource> {
    ...
    // Remove the body payload - DELETE typically doesn't use request body
    const callResponsePromise = this.apiCaller.doCall(
      ['categoryscheme', (body.instanceId || body.uid) as string],
      RequestMethod.DELETE,
      undefined,
      undefined, // ← Changed: no body
      headers,
    );
