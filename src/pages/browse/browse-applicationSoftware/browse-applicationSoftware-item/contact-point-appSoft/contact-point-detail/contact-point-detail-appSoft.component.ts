...
@Component({
  selector: 'app-contact-point-detail-appSoft',
  templateUrl: './contact-point-detail-appSoft.component.html',
  styleUrls: ['./contact-point-detail-appSoft.component.scss'],
})
export class ContactPointDetailAppSoftComponent implements OnInit, OnChanges {
